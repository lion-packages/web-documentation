...
import v14_27_0_CMMD from "./Versions/Commands/v14_27_0_CMMD";
import v14_28_0_CMMD from "./Versions/Commands/v14_28_0_CMMD";
import v14_28_1_CMMD from "./Versions/Commands/v14_28_1_CMMD";
...
import v15_1_0_CMMD from "./Versions/Commands/v15_1_0_CMMD";
import v15_1_1_CMMD from "./Versions/Commands/v15_1_1_CMMD";
...
import v14_27_0_FRM from "./Versions/Framework/v14_27_0_FRM";
import v14_28_0_FRM from "./Versions/Framework/v14_28_0_FRM";
import v14_28_1_FRM from "./Versions/Framework/v14_28_1_FRM";
...
import v15_1_0_FRM from "./Versions/Framework/v15_1_0_FRM";
import v15_1_1_FRM from "./Versions/Framework/v15_1_1_FRM";
...
import v8_6_0_LRT from "./Versions/Libraries/LionRoute/v8_6_0_LRT";
...
import v8_5_0_LSQ from "./Versions/Libraries/LionDatabase/v8_5_0_LSQ";
import v8_6_0_LSQ from "./Versions/Libraries/LionDatabase/v8_6_0_LSQ";
import v8_7_0_LSQ from "./Versions/Libraries/LionDatabase/v8_7_0_LSQ";
...
export default function Content(mdText = "") {
  return {
    commands: {
      "v15.4.1": v15_4_0_CMMD(),
      "v15.4.0": v15_4_0_CMMD(),
      "v15.3.0": v15_3_0_CMMD(),
      "v15.2.0": v15_2_0_CMMD(),
      "v15.1.1": v15_1_1_CMMD(),
      "v15.1.0": v15_1_0_CMMD(),
      "v15.0.1": v15_0_1_CMMD(),
      "v15.0.0": v15_0_0_CMMD(),
      "v14.29.1": v14_29_1_CMMD(),
      "v14.29.0": v14_29_0_CMMD(),
      "v14.28.1": v14_28_1_CMMD(),
      "v14.28.0": v14_28_0_CMMD(),
    ...
    framework: {
      ...
      "v15.4.0": v15_4_0_FRM(mdText),
      "v15.3.0": v15_3_0_FRM(mdText),
      "v15.2.0": v15_2_0_FRM(mdText),
      "v15.1.1": v15_1_1_FRM(mdText),
      "v15.1.0": v15_1_0_FRM(mdText),
      "v15.0.1": v15_0_1_FRM(mdText),
      "v15.0.0": v15_0_0_FRM(mdText),
      "v14.29.1": v14_29_1_FRM(mdText),
      "v14.29.0": v14_29_0_FRM(mdText),
      "v14.28.1": v14_28_1_FRM(mdText),
      "v14.28.0": v14_28_0_FRM(mdText),
