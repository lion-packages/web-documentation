...
export default function v8_8_2_LBD() {
  return {
    driver: {
      title: "LionDatabase\\Driver",
      description:
        "The `Driver` class allows establishing connections to databases`",
      url: "/libraries/lion/database/item_version/driver/run",
      methods: {
        run: {
          title: "Driver::run",
          description:
    ...
    schema: {
      title: "LionDatabase\\Drivers\\MySQL\\Schema",
      description:
        "The `Schema` class allows creating tables with dynamic parameters through arrays",
      url: "/libraries/lion/database/item_version/schema/create",
      methods: {
        create: {
          title: "Schema::create",
