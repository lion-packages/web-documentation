...
const args = [
  {
    key: "type",
    desc: '["enum", "char", "nchar", "nvarchar", "varchar", "longtext", "mediumtext", "text", "tinytext", "date", "time", "timestamp", "datetime", "int", "bigint", "decimal", "double", "float", "mediumint", "real", "smallint", "tinyint"]',
  },
  {
    key: "primary-key",
    desc: "true|false",
...
export default function v8_2_0_LSQ() {
  return {
    driver: {
              ...
              <div className="mb-3">
                ...
                <CodeBlock
                  ...
                  content={
                    "<?php\n\n" +
                    "use LionSQL\\Drivers\\MySQL\\MySQL as DB;\n\n" +
                    "DB::table('my_table')->show()->full()->columns()->getAll();"
                  }
                />
              </div>
            </>
