...
const args = [
  {
    key: "type",
    desc: '["enum", "char", "nchar", "nvarchar", "varchar", "longtext", "mediumtext", "text", "tinytext", "blob", "date", "time", "timestamp", "datetime", "int", "bigint", "decimal", "double", "float", "mediumint", "real", "smallint", "tinyint"]',
  },
  {
    key: "primary-key",
    desc: "true|false",
...
export default function v8_4_0_LSQ() {
  return {
    driver: {
