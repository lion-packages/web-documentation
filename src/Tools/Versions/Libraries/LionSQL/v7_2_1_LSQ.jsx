...
export default function v7_2_1_LSQ() {
  return {
    driver: {
    ...
    mysql: {
      ...
      methods: {
        ...
        union: {
          ...
          code: (
            <>
              <CodeBlock language="sql" content={"(SELECT * FROM my_table) UNION (SELECT * FROM my_table2)"} />
        ...
        "union-all": {
          ...
          code: (
            <>
              <CodeBlock language="sql" content={"(SELECT * FROM my_table) UNION ALL (SELECT * FROM my_table2)"} />
