...
export default function v14_6_0_FRM(mdText) {
  return {
    changelog: {
      name: "Changelog",
      ...
      code: (
        <>
          ...
          <div className="mb-3">
            ...
            <p>
              When creating a command, it is stored by default in the path{" "}
          ...
          <div className="mb-3">
            ...
            <p>
              When creating a socket, it is stored by default in the path{" "}
              <Badge bg="secondary">app/Http/Sockets/</Badge>.
            </p>

            <CodeBlock
              language={"bash"}
              content={"php lion socket:new socket_name"}
            />
        ...
        <>
          ...
          <div className="mb-3">
            <Alert variant={"warning"}>
              ...
              with the <Badge bg={"warning"}>--model</Badge> option.
            </Alert>
