...
export default function v15_0_0_FRM(mdText) {
  return {
    changelog: {
      name: "Changelog",
        ...
        <Tabs defaultActiveKey="list-commands" id="commands" fill>
          ...
          <Tab eventKey="helpers" title="HELPERS">
            <div className="my-3">
              ...
              <p>Use the available features to add color to your chains</p>

              <CodeBlock
                language={"php"}
                content={
                  "<?php\n\n" +
                  "$this->errorOutput('my description...');\n" +
                  "$this->successOutput('my description...');\n" +
                  "$this->warningOutput('my description...');\n" +
                  "$this->infoOutput('my description...');\n" +
                  "$this->purpleOutput('my description...');"
                }
              />

              <p>
                Use the echo function to display strings in the terminal and
                storing it in the current log file.
              </p>

              <CodeBlock
                language={"php"}
                content={
                  "<?php\n\n" + "$this->echo($output, 'my_description...');"
                }
              />
            </div>
          </Tab>
            ...
            <div className="my-3">
              ...
              <CodeBlock
                ...
                content={
                  ...
                  "command=npm run dev\n" +
                  "directory=/var/www/html/resources/lion-dev\n" +
                  "autostart=true\n" +
                  "autorestart=true\n" +
                  "redirect_stderr=true\n" +
                  "stdout_logfile=/var/www/html/storage/logs/resources/lion-dev.log\n\n" +
                  "; sockets\n"
                }
              />
            </div>
        ...
        <Tabs defaultActiveKey="new" id="resources" fill>
          <Tab eventKey="new" title="NEW">
            <div className="my-3">
              ...
              <div className="mb-3">
                <h6 className="text-warning">TWIG</h6>

                <p>To create a twig template resource run the command:</p>

                <CodeBlock
                  language={"bash"}
                  content={"php lion resource:new resource_name --type twig"}
                />
              </div>
              ...
              <div className="mb-3">
                ...
                <p>
                  To create a javascript resource with vite run the command:
                </p>

                <Alert variant="warning">
                  <strong>Note: </strong>the default resource type is{" "}
                  <strong>vite</strong> and the default template is{" "}
                  <strong>react</strong>, to learn more about the properties to
                  generate resources select the <strong>Command</strong> section
                  in the list.
                </Alert>

                <Alert variant="warning">
                  <strong>Note: </strong>every time a vite type resource is
                  created, the base information for the vite configuration is
                  added, where a configuration object will be added to keep the
                  changes in real time, look at the{" "}
                  <strong>vite.config.js</strong> to see the configuration.
                </Alert>

                <CodeBlock
                  language={"bash"}
                  content={"php lion resource:new resource_name --template vue"}
                />

                <CodeBlock
                  language={"bash"}
                  content={
                    "php lion resource:new resource_name --template svelte"
                  }
                />
                ...
                <CodeBlock
                  language={"bash"}
                  content={
                    "php lion resource:new resource_name --template react-ts"
                  }
                />
              </div>
            </div>
          ...
          <Tab eventKey="use" title="USE">
            <div className="my-3">
              ...
              <p>
                When generating a resource of type vite or twig, a log is
                automatically generated in{" "}
                <strong>storage/logs/resources/</strong> this to view the output
                of the local server, the configuration of the resource is added
                in <strong>config/resources.php</strong>. The configuration to
                work faster with <strong>Docker</strong> is added in the
                configuration files <strong>supervisord.conf</strong> and
                <strong>docker-compose.yml</strong> where in the supervisord the
                configurations required to automatically start the resource are
                added, in the docker-compose the resource port created.
              </p>

              <p>
                Run the initialization commands to run the local servers from
                their resources, if you are running the project with Docker you
              ...
              <div className="mb-3">
                ...
                <CodeBlock
                  language={"bash"}
                  content={"php lion resource:serve resource_name"}
                />

                <CodeBlock
                  language={"bash"}
                  content={
                    "php lion resource:serve resource_name --host 0.0.0.0 --port 7001"
                  }
                />
              </div>
          ...
          <Tab eventKey="vite" title="VITE">
            <div className="my-3">
              <h2>VITE.JS</h2>
              <hr />

              <p>
                The use of <strong>NPM</strong> to create projects with{" "}
                <strong>Vite.JS</strong> has been incorporated dynamically, you
                can create any number of resources with <strong>Vite.JS</strong>{" "}
                for your web applications, some basic commands have been
                incorporated to work with <strong>Vite.JS</strong> dependencies
                for your applications Web.
              </p>

              <p></p>

              <div className="mb-3">
                <h6 className="text-warning">INSTALL DEPENDENCIES</h6>
                ...
                <CodeBlock
                  language={"bash"}
                  content={"php lion npm:install resource_name axios"}
                />

                <CodeBlock
                  language={"bash"}
                  content={
                    'php lion npm:install resource_name "axios crypto-js"'
                  }
                />
              </div>

              <div className="mb-3">
                <h6 className="text-warning">UPDATE DEPENDENCIES</h6>
                ...
                <CodeBlock
                  language={"bash"}
                  content={"php lion npm:update resource_name"}
                />
              </div>

              <div className="mb-3">
                <h6 className="text-warning">UNINSTALL DEPENDENCIES</h6>
                ...
                <CodeBlock
                  language={"bash"}
                  content={"php lion npm:uninstall resource_name axios"}
                />

                <CodeBlock
                  language={"bash"}
                  content={
                    'php lion npm:uninstall resource_name "axios crypto-js"'
                  }
                />
              </div>

              <div className="mb-3">
                <h6 className="text-warning">GENERATE DIST</h6>
                ...
                <CodeBlock
                  language={"bash"}
                  content={"php lion npm:build resource_name"}
                />
              </div>
            </div>
          </Tab>
      ...
      code: (
        <>
          ...
          <Alert variant={"warning"}>
            ...
            <strong>$field => name of the field</strong>,{" "}
            <strong>$desc => description of the field</strong>,{" "}
            <strong>$value => default value of the field</strong>,{" "}
            <strong>
              $disabled => modifies whether the field is active or inactive in
              the collection
            </strong>
            .
          </Alert>
