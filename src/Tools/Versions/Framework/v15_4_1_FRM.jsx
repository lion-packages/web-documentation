...
export default function v15_1_0_FRM(mdText) {
  return {
    install: {
      ...
      code: (
        ...
        <div className="mb-3">
          ...
          <p className="fs-4">Lion-Framework supports PHP versions 8.1+</p>
        ...
        <Tabs defaultActiveKey="list-commands" id="commands" fill>
          ...
          <Tab eventKey={"create-commands"} title={"CREATE"}>
            <div className="my-3">
              ...
              <p className="fs-5">Create your commands from the terminal.</p>
          ...
          <Tab eventKey="execute-commands" title="EXECUTE">
            <div className="my-3">
              ...
              <p className="fs-5">execute commands with the command and execute functions.</p>
          ...
          <Tab eventKey="helpers" title="HELPERS">
            <div className="my-3">
              ...
              <p className="fs-5">Use the available features to add color to your chains</p>
        ...
        <Tabs defaultActiveKey="files" id="docker" fill>
          ...
          <Tab eventKey="run" title="RUN">
            <div className="my-3">
              ...
              <p className="fs-5">run the container</p>
        ...
        <Tabs defaultActiveKey="config" id="database" fill>
          ...
          <Tab eventKey="show" title="SHOW">
            <div className="my-3">
              ...
              <p className="fs-5">View all available database connections.</p>
          ...
          <Tab eventKey="export" title="EXPORT">
            <div className="my-3">
              ...
              <p className="fs-5">Export your database using the terminal.</p>
              <CodeBlock
                language={"bash"}
        ...
        <Tabs defaultActiveKey="config" id="email" fill>
          ...
          <Tab eventKey="show" title="SHOW">
            <div className="my-3">
              ...
              <p className="fs-5">View the accounts available in the system.</p>
    ...
    vite: {
      name: "Vite",
      code: (
        <Tabs defaultActiveKey="new" id="vite" fill>
          <Tab eventKey="new" title="NEW">
            <div className="my-3">
              <h2>CREATE PROJECTS WITH VITE</h2>
              <hr />
              ...
              {/* <div className="mb-3">
                ...
                <p className="fs-5">To create a twig template resource run the command:</p>
          ...
          <Tab eventKey="dependencies" title="DEPENDENCIES">
            <div className="my-3">
              ...
              <div className="mb-3">
                ...
                <CodeBlock
                  language={"bash"}
                  content={"php lion npm:install project axios"}
                />

                <CodeBlock
                  language={"bash"}
                  content={
                    'php lion npm:install project "axios crypto-js"'
                  }
                />
              </div>
              ...
              <div className="mb-3">
                ...
                <CodeBlock
                  language={"bash"}
                  content={"php lion npm:update project"}
                />
              </div>
              ...
              <div className="mb-3">
                ...
                <CodeBlock
                  language={"bash"}
                  content={"php lion npm:uninstall project axios"}
                />

                <CodeBlock
                  language={"bash"}
                  content={
                    'php lion npm:uninstall project "axios crypto-js"'
                  }
                />
              </div>
              ...
              <div className="mb-3">
                ...
                <CodeBlock
                  language={"bash"}
                  content={"php lion npm:build project"}
                />
              </div>
            </div>
          </Tab>
      ...
      code: (
        <>
          ...
          <div className="mb-3">
            ...
            <p className="fs-5">equivalent to</p>
      ...
      code: (
        <>
          ...
          <div className="mb-3">
            ...
            <p className="fs-5">characteristics:</p>
          ...
          <div className="mb-3">
            ...
            <p className="fs-5">You can generate the crud of a specific connection.</p>
          ...
          <Tabs defaultActiveKey="new" id="rules" fill>
            ...
            <Tab eventKey="use" title="USE">
              <div className="my-3">
                ...
                <p className="fs-5">You can reuse a rule in different routes.</p>
          ...
          <Tab eventKey="new" title="NEW">
            <div className="my-3">
              ...
              <div className="mb-3">
                ...
                <p className="fs-5">We can add the necessary functions in each middleware.</p>
                ...
                <Row>
                  ...
                  <Col xs={12} sm={12}>
                    <div className="mb-3">
                      ...
                      <p className="fs-5">Function to display a success response.</p>
                  ...
                  <Col xs={12} sm={12}>
                    <div className="mb-3">
                      ...
                      <p className="fs-5">Function to display a error response.</p>
                  ...
                  <Col xs={12} sm={12}>
                    <div className="mb-3">
                      ...
                      <p className="fs-5">Function to display a warning response.</p>
                  ...
                  <Col xs={12} sm={12}>
                    <div className="mb-3">
                      ...
                      <p className="fs-5">Function to display a info response.</p>
                  ...
                  <Col xs={12} sm={12}>
                    <div className="mb-3">
                      ...
                      <p className="fs-5">The helper vd executes the function var_dump.</p>
                  ...
                  <Col xs={12} sm={12}>
                    <div className="mb-3">
                      ...
                      <p className="fs-5">The json helper converts any value to json.</p>
          ...
          <Tabs defaultActiveKey="new" id="test" fill>
            ...
            <Tab eventKey="use" title="USE">
              <div className="my-3">
                ...
                <p className="fs-5">run all tests via command line.</p>
