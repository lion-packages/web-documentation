...
export default function v2_3_0_LH() {
  return {
    arr: {
          ...
          code: (
            <CodeBlock
              ...
              content={
                "<?php\n\n" +
                "use LionHelpers\\Arr;\n\n" +
                "Arr::of(['name' => 'Sleon', 'age' => 23])->values()->get();\n" +
                "// ['Sleon', 23]"
              }
            />
          ),
          ...
          code: (
            <CodeBlock
              ...
              content={
                "<?php\n\n" +
                "use LionHelpers\\Arr;\n\n" +
                "Arr::of(['name' => 'Sleon', 'age' => 23])->keys()->get();\n" +
                "// ['name', 'age']"
              }
            />
          ),
          ...
          code: (
            <CodeBlock
              ...
              content={
                "<?php\n\n" +
                "use LionHelpers\\Str;\n\n" +
                "Str::of('world')->prepend('Hello ')->get();\n" +
                "// 'Hello world'"
              }
            />
          ),
          ...
          code: (
            <CodeBlock
              ...
              content={
                "<?php\n\n" +
                "use LionHelpers\\Str;\n\n" +
                "Str::of('hello world')->headline()->get();\n" +
                "// 'Hello World'"
              }
            />
          ),
              ...
              <div>
                ...
                <CodeBlock
                  ...
                  content={
                    "<?php\n\n" +
                    "use LionHelpers\\Str;\n\n" +
                    "Str::of('hello worl')->limit()->get(); // default 10\n" +
                    "// 'hello world'"
                  }
                />
              </div>
              ...
              <div>
                ...
                <CodeBlock
                  ...
                  content={
                    "<?php\n\n" +
                    "use LionHelpers\\Str;\n\n" +
                    "Str::of('hello world')->limit(8)->get();\n" +
                    "// 'hello wo'"
                  }
                />
              </div>
              ...
              <div>
                ...
                <CodeBlock
                  ...
                  content={
                    "<?php\n\n" +
                    "use LionHelpers\\Str;\n\n" +
                    "Str::of('hello world')->limit(5)->get();\n" +
                    "// 'hello'"
                  }
                />
              </div>
              ...
              <div>
                ...
                <CodeBlock
                  ...
                  content={
                    "<?php\n\n" +
                    "use LionHelpers\\Str;\n\n" +
                    "Str::of('hello world')->limit(20)->get();\n" +
                    "// 'hello world'"
                  }
                />
              </div>
              ...
              <div className="mb-3">
                ...
                <CodeBlock
                  ...
                  content={
                    "<?php\n\n" +
                    "use LionHelpers\\Str;\n\n" +
                    "Str::of('sleon@gmail.com')->mask('*', 7)->get();\n" +
                    "// '*******mail.com'"
                  }
                />
              </div>
              ...
              <div className="mb-3">
                ...
                <CodeBlock
                  ...
                  content={
                    "<?php\n\n" +
                    "use LionHelpers\\Str;\n\n" +
                    "Str::of('   hello world   ')->trim('world')->get();\n" +
                    "// 'hello'"
                  }
                />
              </div>
