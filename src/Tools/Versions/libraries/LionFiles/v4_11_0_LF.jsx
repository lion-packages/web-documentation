...
export default function v4_11_0_LF() {
  return {
    store: {
      ...
      methods: {
        ...
        get: {
          title: "Store::get",
          description: "The get function gets files from a specified path.",
          link: "get",
          code: (
            <div className="mb-3">
              <p>
                The <Badge bg="secondary">get</Badge> function gets files from a
                specified path via file_get_contents.
              </p>
      ...
      methods: {
        ...
        decompress: {
          ...
          code: (
            <div className="mb-3">
              <p>
                The function receives as a parameter the path and the
                destination path of the zip to be decompressed.
              </p>
