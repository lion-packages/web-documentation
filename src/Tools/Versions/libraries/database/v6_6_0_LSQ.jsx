...
export default function v6_6_0_LSQ() {
  return {
    mysql: {
        ...
        init: {
          ...
          code: (
            <>
              ...
              <div className="mb-3">
                <h5 className="pb-2 text-lion-orange">OPERATORS</h5>
                  ...
                  <tbody>
                    {[
                      ...
                      },
                      {
                        ...
                        function: "DB::greaterThan('column')",
                      },
                      {
                        type: "<",
                        description:
