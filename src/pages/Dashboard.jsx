...
const Dashboard = () => {
  return (
    <div className="max-w-screen-md text-white mx-10 my-2">
      <h2 className="font-semibold text-4xl">Install</h2>
      ...
      <p className="my-4">
        Lion-Framework can also serve as an API backend for a JavaScript single
        page application or a mobile application. For example, you can use
        Lion-Framework as an API backend for your ReactJS app or Kotlin app.
      </p>
      ...
      <p className="my-4">
        To install Lion-Framework and libraries you must have composer
        installed, Lion-Framework integrates most of the available Lion
        libraries.
      </p>
    </div>
  );
