...
function LionHelpers() {
  const [info, setInfo] = useState(Content.libraries.lion.helpers.class);
          ...
          <div className="p-2">
            <InputGroup className="mb-3">
              <GithubButton
                ...
                url={"https://github.com/Sleon4/Lion-Helpers"}
              />
