  ...
  return (
    <div className="fixed top-0 w-full md:w-4/5 pb-6">
      <nav className="bg-dark-100 flex items-center justify-between px-4 py-2 lg:py-4 lg:px-20">
          ...
          <form>
            ...
            <div className="relative">
              ...
              <input
                type="search"
                id="default-search"
                className="block w-full p-2 ps-10 text-sm border rounded-lg  bg-dark-300 border-gray-600 placeholder-gray-400 text-gray-300 focus:ring-gray-500 focus:border-gray-500"
                placeholder="Search"
                required
              />
            </div>
        ...
        <div
          className={`md:flex gap-1 text-clr-secundary font-semibold ${
            isOpen ? "flex-col" : "hidden"
          } md:flex-row items-center`}
        >
          <div className="flex gap-4 justify-center items-center">
            <button className="hover:text-primary-100">Framework</button>
            <button className="hover:text-primary-100">Packages</button>
            <button className="hover:text-primary-100">Version</button>
          </div>
